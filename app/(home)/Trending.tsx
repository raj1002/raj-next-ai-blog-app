    ...
    return (
        <Link
            ...
            <div className='absolute z-2 bottom-0 left-0 p-3'>
                <h4 className='inline-block px-5 py-1 font-semibold bg-accent-orange text-whwh-900'>
                    {post?.category}
                </h4>
  ...
  return (
    <section className='pt-3 pb-10'>
        <div className='flex items-center gap-3'>
            ...
            <p className='text-sm'>
                Nunc enim lobortis quam ruisus et feigiat nibhu eu ornare.
                Molestie sit nulla dolor diam turpis.
            </p>
        </div>
        ...
        <p className='text-sm'>
            Brown fox jump over the wall and rushed into the forest.
            Brown fox jump over the wall and rushed into the forest.
            Brown fox jump over the wall and rushed into the forest.
            Brown fox jump over the wall and rushed into the forest.
        </p>
